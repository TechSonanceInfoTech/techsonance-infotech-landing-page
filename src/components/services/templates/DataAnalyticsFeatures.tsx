             ...
             <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-[32px] p-8 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col justify-between overflow-hidden group hover:border-blue-100 transition-all duration-300">
                    <div className="mb-8">
                       <div className="w-12 h-12 bg-white rounded-xl shadow-sm border border-slate-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                          <div className="text-slate-900 w-6 h-6 flex items-center justify-center">{f1.icon}</div>
                       </div>
                ...
                <div className="bg-[#0A1A2F] rounded-[32px] p-10 text-white flex flex-col justify-center relative overflow-hidden group">
                     ...
                     <div className="relative z-10">
                        <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center mb-6 text-brand-cyan backdrop-blur-sm group-hover:bg-white/20 transition-colors">
                           <div className="w-6 h-6 flex items-center justify-center">{f2.icon}</div>
                        </div>
                ...
                {/* Feature 3: Customer Personalization (Light + Bar Chart) */}
                 <div className="bg-white rounded-[32px] p-8 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col justify-between overflow-hidden group hover:border-blue-100 transition-all duration-300">
                    <div className="mb-8">
                       <div className="flex items-center gap-3 mb-6">
                            <div className="text-brand-cyan w-6 h-6 flex items-center justify-center">{f3.icon}</div>
                 ...
                 <div className="bg-white rounded-[32px] p-8 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col justify-between overflow-hidden group hover:border-blue-100 transition-all duration-300">
                    <div className="mb-8">
                       <div className="flex items-center gap-3 mb-6">
                            <div className="text-blue-600 w-6 h-6 flex items-center justify-center">{f4.icon}</div>
