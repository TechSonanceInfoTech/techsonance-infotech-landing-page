          ...
          <div className="flex flex-col sm:flex-row items-center gap-2.5 md:gap-3 justify-center">
            ...
            <div className="flex gap-2">
              <a
                ...
                className="w-9 h-9 md:w-10 md:h-10 bg-white/5 hover:bg-gradient-to-br hover:from-brand-cyan hover:to-cyan-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 touch-target"
                aria-label="LinkedIn"
              >
