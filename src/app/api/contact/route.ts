...
export async function POST(req: Request) {
  try {
    ...
    const { firstName, lastName, email, description, captchaToken } = body;
          ...
          <div class="email-container">
            ...
            <div class="content">
              ...
              <div style="background-color: #e8f5e9; padding: 15px; border-radius: 8px; text-align: center; color: #2e7d32;">
                <strong>📧 This quote request was submitted via TechSonance Get Quote Modal</strong><br>
            ...
            <div class="footer">
              ...
              <div style="font-size: 11px; color: #888; margin-top: 15px;">
                This is an automated email from TechSonance Quote Portal.<br>
