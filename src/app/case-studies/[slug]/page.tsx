          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4 pt-4">
                <Link href="#consultancy-section" className="px-8 py-3 bg-gradient-to-r from-brand-cyan to-brand-deep text-white font-bold rounded-lg hover:scale-105 transition-all duration-300 shadow-lg shadow-cyan-500/20">
                  Estimate Project
                </Link>
            ...
            <section className="bg-brand-dark text-white p-10 md:p-14 rounded-3xl relative overflow-hidden">
              <div className="relative z-10 text-center">
                ...
                <div className="inline-block bg-white/10 backdrop-blur-md border border-white/20 p-10 rounded-[32px] max-w-lg w-full">
                  ...
                  <Link href="#consultancy-section" className="inline-block px-12 py-5 bg-gradient-to-r from-brand-cyan to-brand-deep text-white font-bold text-xl rounded-full hover:scale-105 transition-all duration-300 shadow-xl shadow-cyan-500/20 border-2 border-transparent">
                    Let's Talk Business
                  </Link>
                </div>
              </div>
