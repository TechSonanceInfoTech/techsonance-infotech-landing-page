    ...
    <div className="min-h-screen bg-gray-50 pt-24 pb-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-16">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
               <button className="px-6 py-3.5 bg-brand-cyan text-white font-semibold rounded-lg shadow-md hover:bg-cyan-600 transition-all duration-200 hover:shadow-lg">
                 Start 15 Days 100% FREE Trial
               </button>
               <button className="px-6 py-3.5 bg-white text-brand-cyan border-2 border-brand-cyan font-semibold rounded-lg hover:bg-cyan-50 transition-all duration-200">
      ...
      <div className="w-full border-t border-gray-200 flex flex-col lg:flex-row">
        ...
        <div className="lg:w-[420px] bg-cyan-50 py-12 md:py-16 px-6 md:px-10 flex flex-col justify-center items-start relative overflow-hidden">
           ...
           <button className="bg-brand-cyan hover:bg-cyan-600 text-white font-semibold py-3.5 px-8 text-base rounded-lg shadow-md relative z-10 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5">
             Hire Us
           </button>
        </div>
