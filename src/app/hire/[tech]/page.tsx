...
export default function HireTechPage() {
  const params = useParams()
  const techSlug = Array.isArray(params.tech) ? params.tech[0] : params.tech
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="px-6 py-3.5 bg-gradient-to-r from-brand-cyan to-brand-deep text-white font-semibold rounded-lg shadow-md hover:scale-105 transition-all duration-200 hover:shadow-lg shadow-cyan-500/20"
              >
          ...
          >
            ...
            {formStatus.type === 'success' ? (
              ...
              <form action={handleSubmit} className="space-y-4">
                ...
                <Button
                  disabled={isPending}
                  className="w-full h-12 bg-gradient-to-r from-brand-cyan to-brand-deep hover:scale-105 text-white font-semibold text-base rounded-lg shadow-md transition-all duration-200 shadow-cyan-500/20"
                >
      ...
      <div className="w-full border-t border-gray-200 flex flex-col lg:flex-row">
        ...
        <div className="lg:w-[420px] bg-cyan-50 py-12 md:py-16 px-6 md:px-10 flex flex-col justify-center items-start relative overflow-hidden">
          ...
          <button
            ...
            className="bg-gradient-to-r from-brand-cyan to-brand-deep hover:scale-105 text-white font-semibold py-3.5 px-8 text-base rounded-lg shadow-md relative z-10 transition-all duration-200 hover:shadow-lg shadow-cyan-500/20 hover:-translate-y-0.5"
          >
            Hire Us
          </button>
        </div>
