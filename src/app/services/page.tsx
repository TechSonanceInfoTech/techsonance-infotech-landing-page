      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="text-brand-cyan font-semibold text-sm uppercase tracking-wider mb-3 block">In-Depth Solutions</span>
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-5">Our Expertise</h2>
            <div className="h-1.5 w-24 bg-gradient-to-r from-brand-cyan to-cyan-400 mx-auto rounded-full" />
          </motion.div>

          <div className="space-y-24">
            {servicesConfig.detailedServices.map((service, index) => (
